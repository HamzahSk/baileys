 ...
 * * Modifikasi: Mendukung Node.js & Bun Runtime
 *
 * If you use or copy this code, please credit my name or project. AND DO NOT CHANGE THIS NOTE
 * @itsliaaa/baileys
 */
import { randomUUID, randomBytes, getRandomValues } from 'node:crypto'; // Menggunakan prefix node: untuk kompatibilitas
...
// Lia@Changes 09-04-26 --- Inject buffer into unifiedResponse.data to support proper rendering of rich messages
